...
protected:
    ...
    virtual bool verify_app_path(const std::string& app_path) = 0;
...
public:
    ...
    bool verify_app_path(const std::string& app_path) override;
    void set_and_save_game_exe_path(const std::string& app_exe_path);
